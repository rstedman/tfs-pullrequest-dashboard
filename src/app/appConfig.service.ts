      ...
      return new Promise<boolean>((resolve, reject) => {
        ...
        VSS.require(["TFS/VersionControl/GitRestClient", "VSS/Identities/RestClient", "VSS/Context", "TFS/Dashboards/WidgetHelpers", "TFS/Core/RestClient"],
          (gitFactory: GitClientFactory, identityFactory: IdentitiesClientFactory, context: Context, widgetHelpers: any, coreClientFactory: CoreHttpClientFactory) => {
              ...
              if (pageContext.navigation.routeId) {
                // In Azure Devops 2019 you can use routeId to determine if you're in the dashboards hub
                this._layout.widgetMode = pageContext.navigation.routeId.startsWith("ms.vss-dashboards-web");
              }
              if (pageContext.hubsContext.selectedHubId && !this._layout.widgetMode) {
                // In VSTS 2017 you can use selectedHubId to determine if you're in the dashboards hub
